...
create SEQUENCE hibernate_sequence INCREMENT BY 1 START WITH 1 CACHE 1000;
CREATE SEQUENCE BCK_PARAMETERS INCREMENT BY 1 START WITH 1 CACHE 1000;
---
...
CREATE INDEX prc_service_idx_5 ON prc_service (service_description);
...
---Insert new Rule Codes
  ...
  insert into bck_rule values ( BCK_DIMENSIONS_UID.nextval, 'R40-1','Validação Terminais Faturados', null, null, null,null, null);
  insert into bck_rule values ( BCK_DIMENSIONS_UID.nextval, 'R40-2','Validação Terminais Faturados', null, null, null,null, null);
  insert into bck_rule values ( BCK_DIMENSIONS_UID.nextval, 'R40-3','Validação Terminais Faturados', null, null, null,null, null);
  insert into bck_rule values ( BCK_DIMENSIONS_UID.nextval, 'R40-4','Validação Terminais Faturados', null, null, null,null, null);
  insert into bck_rule values ( BCK_DIMENSIONS_UID.nextval, 'R40-5','Validação Terminais Faturados', null, null, null,null, null);
  insert into bck_rule values ( BCK_DIMENSIONS_UID.nextval, 'R40-6','Validação Terminais Faturados', null, null, null,null, null);  
  ...
  insert into bck_rule values ( BCK_DIMENSIONS_UID.nextval, 'R71-1','Validação do Serviço Gestão', null, null, null,null, null);   
  insert into bck_rule values ( BCK_DIMENSIONS_UID.nextval, 'R71-2','Validação do Serviço Gestão', null, null, null,null, null);  
