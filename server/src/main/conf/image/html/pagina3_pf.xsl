...
<html id="session3_">'<xsl:value-of select="$pageCounter"/>'
...
<div id="pagina3" class="pagina3">
	...
	<div style="width:776;float:left;margin-top:-17px;">
		...
		<span id="R05-4_minutosFranqueados"></span>
		<!--  minutos  -->
		<div class="f12" style="width:100px;float:left;text-align:left;">
			<b>
