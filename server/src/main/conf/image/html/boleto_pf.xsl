...
<xsl:stylesheet 
  ...
  version="1.0">
	...
	<xsl:template name="pagina_boleto_pf" match="/SIRS/CYCLE_SUMMARY">
...
<div id="pagina1" class="pagina1">
	...
	<!-- pontos -->
	<div class="detalheBoleto4">
			<div class="boxBoleto4_1">
					<div style="float:left;width:776px;margin:0px;padding:0px;">
						<div class="boxClara2PX_1"></div>
						<div class="boxClara2PX_2" style="width:772px;"></div>
						<div class="boxClara2PX_3"></div>
					...
					<div style="float:left;width:776px;margin:0px;padding:0px;">
						<div class="boxClara2PX_4" style="height:76px;"></div>
						<div class="boxClara2PX_conteudo" style="width:772px;height:76px;">
							<div class="f12" style="width:472;height:76;float:left;padding-left:5px;">
								<b>Programa de pontos</b><br></br><br></br>
								Pontuação referente a conta: <xsl:value-of select="$accountNumber"/><br></br>
								Posição em: <xsl:value-of select="vivo:DateFormat.formatDDMMYYYY($context/RewardInformation/@rewardDate)"/><br></br>
								Saldo Total de pontos: <xsl:value-of select="$context/RewardInformation/@rewardBalance"/><br></br>
							</div>
							<div class="f11" style="width:300;height:76;float:left;">
						...
						<div class="boxClara2PX_5" style="height:76px;"></div>
					</div>
					<div style="float:left;width:776px;margin:0px;padding:0px;">
						<div class="boxClara2PX_6"></div>
						<div class="boxClara2PX_7" style="width:772px;"></div>
