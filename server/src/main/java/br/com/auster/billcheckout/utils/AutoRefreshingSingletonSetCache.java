...
public abstract class AutoRefreshingSingletonSetCache<E> extends NonLazySingletonSetCache<E> {

	private final Logger log = Logger.getLogger(AutoRefreshingSingletonSetCache.class);
