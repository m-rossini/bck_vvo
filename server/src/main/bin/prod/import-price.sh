...
sqlplus -S billchkow/billchkow@BILLCPR1 @conf/sql/truncate-service-price.sql

echo Clean Table: prc_service
sqlplus -S billchkow/billchkow@BILLCPR1 @conf/sql/delete-service.sql

echo Clean Table: prc_service_free_units
sqlplus -S billchkow/billchkow@BILLCPR1 @conf/sql/delete-service-free-units.sql
...
ImportId=`sqlplus -S billchkow/billchkow@BILLCPR1 @conf/sql/select-import-id.sql | tail -2 | head -1 | sed -e 's/^ *//' -e 's/ *$//'`
