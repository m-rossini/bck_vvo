...
public class SelfContainedTest03 {

	public SelfContainedTest03() {
		
	}
	
	public static void main(String[] args) throws Exception {
		SelfContainedTest03 test = new SelfContainedTest03();
	...
	public void createAll() throws Exception {
		...
		builder.addPackageFromDrl(new FileReader("src/test/java/br/com/auster/billcheckout/om/doubles.drl"));
