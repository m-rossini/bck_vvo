		...
		<table width="100%" height="100%" cellpadding="0" cellspacing="0">
	 	<tr valign="top">
        	<td height="15">
	            ...
	            <tr>
                	<td height="100%" class="table-title"><bean:message key="text.editGroupTableTitle" bundle="users"/></td>
				</tr>
            	</table>
            </td>
		</tr>
...
<html:form action="/update-group" method="post">
				...
				<tr>
       				...
       				<td class="textBlue"> <div align="left"><bean:message key="text.groupRulesEditorPermissionColumn" bundle="users"/></div></td>
       				<td class="text8"><div align="left"><html:multibox name="updateGroupForm" property="permissionId"  value="<%=PermissionConstants.PERMISSION_RULES_EDITOR_KEY%>"/></div></td>
				</tr>
