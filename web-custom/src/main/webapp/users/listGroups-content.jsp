		...
		<tr  valign="top">
			<td height="100%" width="100%">
				...
				<tr class="table-column-title">
					<td><div align="left"><bean:message key="text.groupNameColumn" bundle="users"/></div></td>
					<td><div align="center"><bean:message key="text.viewRequestsPermissionsColumn" bundle="users"/></div></td>
					<td><div align="center"><bean:message key="text.createRequestPermissionsColumn" bundle="users"/></div></td>
					<td><div align="center"><bean:message key="text.iqPermissionColumn" bundle="users"/></div></td>
					<td><div align="center"><bean:message key="text.userCreatePermissionColumn" bundle="users"/></div></td>
					<td><div align="center"><bean:message key="text.groupViewPermissionColumn" bundle="users"/></div></td>
					<td><div align="center"><bean:message key="text.groupCreatePermissionColumn" bundle="users"/></div></td>
					<td><div align="center"><bean:message key="text.groupRequestManagerPermissionColumn" bundle="users"/></div></td>
					<td><div align="center"><bean:message key="text.groupRulesEditorPermissionColumn" bundle="users"/></div></td>
				</tr>
...
<logic:notEmpty name="groupList">
	...
	<logic:iterate name="groupList" id="groupAtList">
  			...
  			<tr class="text8">
					...
					<td>
						<div align="center">
						<% if (groupPermissions.containsKey(PermissionConstants.PERMISSION_RULES_EDITOR_KEY)) { %>
							<html:img page="/images/yes.jpg"/>
						<% } else { %>
							<html:img page="/images/no.jpg"/>
						<% } %>
				...
				<tr height="25" valign="middle">
	    			<td colspan="9" class="textBlue"><div align="right">
	    			<html:link action="/list-users">:: <bean:message key="text.showUsers" bundle="users"/> ::</html:link>&nbsp;&nbsp;
			<% if (user.hasPermission(PermissionConstants.PERMISSION_USER_GOUPS_CREATE_KEY)) { %>
