...
public class JBRMSEntryPoint implements EntryPoint, HistoryListener {
  ...
  public void onModuleLoad() {
    ...
    loginAusterUser(loggedInUserInfo);
...
public void show(ComponentInfo info, boolean affectHistory) {
  ...
  private void showPackages() {
    show(list.find("Packages"), false);
  }
  
  private void loginAusterUser(LoggedInUserInfo loginInfo){
	  RepositoryServiceFactory.login( "auster", "auster", null);
	  loginInfo.setUserName("auster");
      loggedInUserInfo.setVisible( false );
  }
}